...
import com.voxhumana.gameobjects.Grass;
import com.voxhumana.gameobjects.Pipe;
...
public class GameRenderer {
	...
	//These objects are created for the game.
	private Bird bird;
	...
	//These are the textures used in the game.
	...
	public void render(float runTime){
        ...
        batcher.begin();
        //Disables transparency; good for performance when drawing images that don't need it
        ...
        //Enables transparency again since the bird and the skulls need it
        batcher.enableBlending();
        
        //Draw skulls
        drawSkulls();
        
        //Draws the bird depending on whether the bird is flapping
        ...
        if(myWorld.isReady()) {
        	...
        	if(myWorld.isGameOver() || myWorld.isHighScore()){
                ...
                //Draws the text on top of the shadow
